...
//                  cd.id = c.getString(0);
                    ...
                    cd.gShockEventThreshold = c.getDouble(c.getColumnIndex("GShockEventThreshold"));
                    ...
                    Log.d("ODDC SENDTOFLA",cd.timestamp + " " + cd.sessionID+" "+cd.latitude+" "+cd.speed+" "+cd.gShockEvent+" "+cd.fcwEvent+" "+cd.ldwEvent+" "+cd.mediaURI+" "+cd.mediaDeleted+"  " + cd.mediaUploaded+" "+cd.dataUploaded);
                }
                c.close();
