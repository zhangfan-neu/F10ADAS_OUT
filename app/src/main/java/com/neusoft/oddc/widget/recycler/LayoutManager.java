...
public class LayoutManager extends RecyclerView.LayoutManager {
    ...
    public RecyclerView.LayoutParams generateLayoutParams(Context c, AttributeSet attrs) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
            ...
            isString =
                    a.getType(
                            R.styleable.superslim_LayoutManager_slm_section_sectionManager) == TypedValue.TYPE_STRING;
        }
    ...
    public static class LayoutParams extends RecyclerView.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
                ...
                isDimension =
                        a.getType(
                                R.styleable.superslim_LayoutManager_slm_section_headerMarginStart) == TypedValue.TYPE_DIMENSION;
                loadHeaderStartMargin(a, isDimension);

                isDimension =
                        a.getType(
                                R.styleable.superslim_LayoutManager_slm_section_headerMarginEnd) == TypedValue.TYPE_DIMENSION;
