...
public class MyViewDragHelper {
    ...
    public static MyViewDragHelper create(ViewGroup forParent, Callback cb) {
        return new MyViewDragHelper(forParent.getContext(), forParent, null, cb);
    }

    /**
     * Factory method to create a new MyViewDragHelper with the specified interpolator.
     *
     * @param forParent    Parent view to monitor
     ...
     * @return a new MyViewDragHelper instance
     */
    public static MyViewDragHelper create(ViewGroup forParent, Interpolator interpolator, Callback cb) {
        return new MyViewDragHelper(forParent.getContext(), forParent, interpolator, cb);
    }
     ...
     * @return a new MyViewDragHelper instance
     */
    public static MyViewDragHelper create(ViewGroup forParent, float sensitivity, Interpolator interpolator, Callback cb) {
        final MyViewDragHelper helper = create(forParent, interpolator, cb);
        helper.mTouchSlop = (int) (helper.mTouchSlop * (1 / sensitivity));
        return helper;
    }
     ...
     * @param interpolator interpolator for scroller
     */
    private MyViewDragHelper(Context context, ViewGroup forParent, Interpolator interpolator, Callback cb) {
        if (forParent == null) {
